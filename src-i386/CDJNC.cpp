...
//[[Rcpp::export]]
std::vector<Eigen::MatrixXd> tune_cdj(Eigen::MatrixXd &x, Eigen::VectorXd &y, std::string pen="mcp", std::string nnn="sqrtn", int N=100, double Lmin=1.0e-5, double ga=1.0e-10, double mu=0.5, int imax=1, double tol=1.0e-5){
